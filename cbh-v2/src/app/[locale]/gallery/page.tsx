        ...
        <div className="container">
          ...
          <div className={`${
            ...
            {filteredImages.map((image, index) => (
              <div
                key={image.id}
                className={`group relative overflow-hidden rounded-lg cursor-pointer animate-in fade-in slide-in-up ${
              ...
              >
                <div className={`relative ${
                  viewMode === 'grid' 
                    ? 'h-64' 
                    : index % 3 === 0 ? 'h-96' : index % 3 === 1 ? 'h-72' : 'h-80'
                }`}>
                  <Image
                    src={image.src}
                    alt={image.title}
      ...
      {selectedImage && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/95">
          ...
          <button
            ...
            className="absolute right-16 p-2 text-white hover:bg-white/20 rounded-lg transition-colors"
          >
          ...
          <div className="relative w-full h-full max-w-7xl max-h-[90vh] mx-auto p-4">
            ...
            {/* Image Info */}
            <div className="absolute bottom-8 left-8 right-8 bg-black/60 backdrop-blur-sm p-4 rounded-lg text-white">
              ...
              <span className="inline-block mt-2 px-3 py-1 bg-primary-600 rounded-full text-sm">
      ...
      <section className="py-20 bg-white">
        <div className="container text-center">
          ...
          <a
            ...
            className="inline-block px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg font-semibold text-lg hover:shadow-2xl transition-all hover:scale-105"
          >
            @crescentbeachhotel
          </a>
        </div>
