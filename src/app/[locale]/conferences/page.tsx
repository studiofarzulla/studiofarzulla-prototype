  ...
  return (
    <div className='min-h-screen'>
      ...
      <section className="section-padding bg-gradient-to-r from-blue-50 to-indigo-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="heading-secondary mb-4">Trusted by Leading Organizations</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We've proudly hosted major international corporations, sports organizations, 
              and government entities for their most important events and meetings.
            </p>
          </div>
            ...
            <div className="bg-white rounded-lg shadow-soft p-8">
              <div className="flex items-start mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Long-term relationships with industry leaders</p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-blue-500 pl-4">
                  ...
                  <p className="text-gray-600 text-sm mb-2">Italian Multinational Oil & Gas Company</p>
                  <p className="text-gray-700">
                    Multi-week corporate training programs, executive retreats, and international 
                    team building events. Consistent choice for Azerbaijan operations.
                  </p>
                </div>
                
                <div className="border-l-4 border-green-500 pl-4">
                  <h4 className="font-semibold text-lg">BP (British Petroleum)</h4>
                  <p className="text-gray-600 text-sm mb-2">Global Energy Corporation</p>
                  <p className="text-gray-700">
                    High-level executive meetings, strategic planning sessions, and 
                    regional management conferences for Caspian operations.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-soft p-8">
              <div className="flex items-start mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">International sports and entertainment events</p>
                </div>
              </div>
              
              <div className="space-y-6">
                <div className="border-l-4 border-red-500 pl-4">
                  <h4 className="font-semibold text-lg">Baku City Circuit (Formula 1)</h4>
                  <p className="text-gray-600 text-sm mb-2">Azerbaijan Grand Prix Organization</p>
                  <p className="text-gray-700">
                    Annual employee appreciation events, corporate hospitality, and 
                    international media briefings during F1 race weekends.
                  </p>
                </div>
                
                <div className="border-l-4 border-orange-500 pl-4">
                  <h4 className="font-semibold text-lg">FIFA Beach Soccer</h4>
                  <p className="text-gray-600 text-sm mb-2">International Football Association</p>
                  <p className="text-gray-700">
                    Tournament planning meetings, international delegation hosting, 
                    and official FIFA committee sessions for beach football events.
                  </p>
                </div>
                
                <div className="border-l-4 border-purple-500 pl-4">
                  <h4 className="font-semibold text-lg">International Handball Teams</h4>
                  <p className="text-gray-600 text-sm mb-2">European National Teams</p>
                  <p className="text-gray-700">
      ...
      <section className="section-padding bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="heading-secondary mb-6">Corporate Building Rental</h2>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Rent entire buildings for extended corporate programs, training sessions, 
                and team retreats. Each building contains 20 premium rooms with dedicated 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div className="bg-white p-6 rounded-lg shadow-soft">
                  ...
                  <h4 className="font-semibold mb-2">Dedicated Meeting Space</h4>
                  <p className="text-gray-600 text-sm">
              ...
              <div className="flex gap-4">
                ...
                <Button variant="outline" size="lg">View Floor Plans</Button>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="absolute bottom-6 left-6 text-white">
                <h3 className="text-2xl font-bold">Corporate Building Complex</h3>
                <p className="text-gray-200">Dedicated corporate accommodation facilities</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="heading-secondary mb-4">Team Building & Corporate Recreation</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Combine business with pleasure through our comprehensive team building programs 
              and recreational activities designed to strengthen corporate relationships.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl mb-8 text-primary-100 leading-relaxed">
                Our experienced event planning team is ready to help you create a successful 
                and memorable corporate event. From initial planning to final execution, 
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-lg">Available 24/7 for international clients</span>
                </div>
              </div>
            ...
            <div className="bg-white/10 rounded-2xl p-8">
              <h3 className="text-2xl font-bold mb-6">Event Planning Process</h3>
              <div className="space-y-6">
