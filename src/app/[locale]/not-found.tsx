        ...
        <div>
          ...
          <div className='mb-8'>
            ...
            <p className='text-lg text-gray-600 max-w-2xl mx-auto mb-6'>
              We're sorry, but the page you're looking for seems to have sailed
              away. Don't worry, there are plenty of other beautiful
              destinations to explore at The Crescent Beach Hotel.
            </p>
          </div>
                ...
                <div key={item.href}>
                  ...
                  >
                    <div className='text-lg font-semibold text-gray-900 group-hover:text-primary-600 mb-2'>
                      {item.key.split('.')[1]?.charAt(0).toUpperCase() +
                        item.key.split('.')[1]?.slice(1) || 'Home'}
                    </div>
          ...
          <div className='mt-12 bg-gradient-to-r from-primary-500 to-accent-500 rounded-2xl p-8 text-white'>
            ...
            <p className='text-white/90 mb-6'>
              Our friendly staff is available 24/7 to help you find what you're
              looking for
            </p>
