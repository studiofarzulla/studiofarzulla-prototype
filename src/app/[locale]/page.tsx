  ...
  const restaurants = [
    {
      name: 'The Terrace',
      description:
        'Elegant fine dining restaurant offering international cuisine with breathtaking panoramic views of the Caspian Sea.',
    ...
    },
    {
      name: 'Wild West',
      description:
        'Unique themed restaurant bringing American frontier atmosphere with authentic Western cuisine and entertainment.',
        ...
        <div className='container mx-auto px-4'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            {featuredRooms.map((room, index) => (
              <RoomPreview key={room.id} {...room} index={index} />
            ))}
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div className='text-center p-6 rounded-2xl bg-gradient-to-br from-primary-50 to-primary-100'>
              ...
              <p className='text-primary-700'>
                Official accommodation partner for international beach football
            ...
            <div className='text-center p-6 rounded-2xl bg-gradient-to-br from-accent-50 to-accent-100'>
              ...
              <h3 className='text-xl font-semibold mb-3 text-accent-900'>
                Baku City Circuit
              </h3>
              <p className='text-accent-700'>
                Premium hospitality services during Formula 1 and motorsport
                events in Baku.
              </p>
            </div>
            ...
            <div className='text-center p-6 rounded-2xl bg-gradient-to-br from-secondary-50 to-secondary-100'>
              ...
              <p className='text-secondary-700'>
                Host to handball teams and sports delegations from across Europe
                and beyond.
              </p>
            </div>
          </div>
