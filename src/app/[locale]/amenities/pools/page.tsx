          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12'>
            <div className='lg:col-span-2'>
              ...
              <p className='text-lg text-gray-600 mb-6 leading-relaxed'>
                Our swimming pool complex features three distinct pools designed
                to cater to every guest's preferences and needs. From the
                breathtaking infinity pool with panoramic Caspian Sea views to
                our climate-controlled indoor facility, each pool offers a
                unique and luxurious experience.
              </p>
              <p className='text-gray-600 mb-8 leading-relaxed'>
                All pools are maintained to the highest standards with
                professional lifeguard services, premium amenities, and
                dedicated staff ensuring your safety and comfort. Whether you're
                seeking active swimming, peaceful relaxation, or family fun, our
                pools provide the perfect aquatic environment.
              </p>
              ...
              <div className='grid grid-cols-1 sm:grid-cols-2 gap-6'>
                <div className='bg-blue-50 p-6 rounded-lg'>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Stunning infinity edge creating a seamless connection with
                    the Caspian Sea horizon
                  </p>
                </div>
                ...
                <div className='bg-blue-50 p-6 rounded-lg'>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Indoor pool with perfect temperature control for year-round
                    swimming comfort
                  </p>
                </div>
              </div>
        ...
        <div className='container mx-auto px-4'>
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            ...
            <div>
              ...
              <p className='text-lg text-gray-600 mb-6 leading-relaxed'>
                Enjoy refreshing beverages and delicious light meals without
                leaving the pool area. Our poolside bar and grill offers a full
                menu of tropical drinks, healthy snacks, and fresh meals
                delivered right to your lounger.
              </p>
              ...
              <div className='grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8'>
                <div className='bg-white p-4 rounded-lg shadow-soft'>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Fresh fruit cocktails and premium beverages
                  </p>
                </div>
                ...
                <div className='bg-white p-4 rounded-lg shadow-soft'>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Healthy salads, grilled items, and fresh seafood
                  </p>
                </div>
              </div>
              ...
              <div className='space-y-4'>
                ...
                <ul className='space-y-2 text-gray-600'>
                  ...
                  <li className='flex items-center'>
                    <div className='w-2 h-2 bg-blue-500 rounded-full mr-3'></div>
                    <span className='text-sm'>
                      Service to your poolside lounger
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <div className='container mx-auto px-4'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-600 max-w-2xl mx-auto'>
              Join our various pool-based activities and fitness programs
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div className='bg-white rounded-lg shadow-soft p-8 text-center'>
              ...
              <p className='text-gray-600 mb-4'>
                Low-impact water aerobics classes suitable for all fitness
                levels, led by certified instructors.
              </p>
            ...
            <div className='bg-white rounded-lg shadow-soft p-8 text-center'>
              ...
              <p className='text-gray-600 mb-4'>
                Professional swimming instruction for adults and children, from
                beginners to advanced techniques.
              </p>
              <ul className='text-sm text-gray-600 space-y-2 mb-6'>
            ...
            <div className='bg-white rounded-lg shadow-soft p-8 text-center'>
              ...
              <p className='text-gray-600 mb-4'>
                Dedicated family hours with supervised activities and games for
        ...
        <div className='container mx-auto px-4'>
          <div className='text-center max-w-3xl mx-auto'>
            ...
            <p className='text-xl text-blue-100 mb-8 leading-relaxed'>
              Experience the ultimate in aquatic luxury at our world-class pool
              facilities. Whether you prefer the stunning infinity pool or the
              comfort of our indoor facility, paradise awaits.
            </p>
