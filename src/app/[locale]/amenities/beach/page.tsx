          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Our exclusive 500-meter private beach offers guests unparalleled access to the pristine 
                waters of the Caspian Sea. With dedicated beach staff, premium amenities, and a variety 
                of water activities, it's the perfect place to relax, play, and create unforgettable memories.
              </p>
              <p className="text-gray-600 mb-8 leading-relaxed">
                The beach features soft sand, crystal-clear water, and is completely private to hotel guests. 
                Whether you prefer active water sports or peaceful relaxation, our beach caters to every preference 
                with professional staff ensuring your comfort throughout your stay.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="bg-blue-50 p-6 rounded-lg">
                  ...
                  <p className="text-gray-600 text-sm">
                    Clean, clear Caspian Sea water perfect for swimming and water activities
                  </p>
                </div>
                ...
                <div className="bg-blue-50 p-6 rounded-lg">
                  ...
                  <p className="text-gray-600 text-sm">
                    Dedicated beach staff providing towels, drinks, and personalized service
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-lg shadow-soft p-6">
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-center">
                    <div className="w-2 h-2 bg-blue-500 rounded-full mr-3"></div>
                    <span className="text-sm">Professional lifeguard on duty</span>
                  </li>
                  <li className="flex items-center">
                    <div className="w-2 h-2 bg-blue-500 rounded-full mr-3"></div>
                  ...
                  <li className="flex items-center">
                    <div className="w-2 h-2 bg-blue-500 rounded-full mr-3"></div>
                    <span className="text-sm">Beachside food & beverage service</span>
                  </li>
                  <li className="flex items-center">
                    <div className="w-2 h-2 bg-blue-500 rounded-full mr-3"></div>
              ...
              <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg p-6">
                ...
                <p className="text-blue-100 text-sm mb-4">Daily: 8:00 AM - 8:00 PM</p>
                <p className="text-blue-100 text-sm">
                  Lifeguard on duty during all operating hours. Evening beach access available for hotel guests.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="section-padding bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="heading-secondary mb-4">Water Sports & Activities</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-soft overflow-hidden">
              ...
              <div className="p-6">
                <p className="text-gray-600 text-sm mb-4">
                  Professional volleyball court with equipment provided. Daily tournaments and casual games welcome.
                </p>
            ...
            <div className="bg-white rounded-lg shadow-soft overflow-hidden">
              ...
              <div className="p-6">
                <p className="text-gray-600 text-sm mb-4">
                  Variety of water sports including kayaking, paddleboarding, and jet skiing with safety equipment.
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
            ...
            <div className="bg-white rounded-lg shadow-soft overflow-hidden">
              ...
              <div className="p-6">
                <p className="text-gray-600 text-sm mb-4">
                  Quiet areas with premium sunbeds, umbrellas, and personalized beach service for ultimate relaxation.
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
        ...
        <div className="container mx-auto px-4">
          <div className="bg-gradient-to-r from-primary-600 to-secondary-600 rounded-2xl p-8 lg:p-12 text-white">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-3xl font-bold mb-4">Premium Beach Services</h2>
                <p className="text-lg text-primary-100 mb-6">
                  Enhance your beach experience with our comprehensive range of personalized services 
              ...
              <div className="text-center">
                <h3 className="text-2xl font-bold mb-6">Ready for Beach Paradise?</h3>
