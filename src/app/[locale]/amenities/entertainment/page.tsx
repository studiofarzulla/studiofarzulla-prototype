...
export const metadata: Metadata = {
  ...
  description: 'Experience world-class entertainment at our professional stage venue featuring live music, cultural shows, and special events with stunning Caspian Sea backdrop.',
};
  ...
  const weeklyEvents = [
    {
      ...
      description: "Intimate acoustic performances featuring local and international artists",
      type: "Live Music"
    },
    {
      day: "Tuesday",
      ...
      description: "Traditional Azerbaijani folk dances and cultural performances",
      type: "Cultural Show"
    },
    {
      day: "Wednesday",
    ...
    },
    {
      ...
      description: "Family-friendly shows, magic acts, and interactive entertainment",
      type: "Family Show"
    }
  ];
  ...
  const stageFeatures = [
    {
      ...
      description: "State-of-the-art audio equipment with crystal clear acoustics",
      icon: Volume2
    },
    {
      title: "Dynamic Lighting",
      description: "Professional stage lighting with color-changing LED systems",
      icon: Spotlight
    },
    {
    ...
    },
    {
      ...
      description: "Covered performance area suitable for all weather conditions",
      icon: Users
    },
    {
      ...
      <section className="section-padding">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <h2 className="text-3xl font-bold mb-6">Professional Entertainment Venue</h2>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Our entertainment stage is a world-class outdoor venue that has hosted renowned 
                international artists, cultural performers, and special events. With professional 
                sound and lighting systems, the stage provides an unforgettable experience for 
                both performers and audiences.
              </p>
              <p className="text-gray-600 mb-8 leading-relaxed">
                Set against the backdrop of the Caspian Sea, our venue offers a magical atmosphere 
                for evening performances. From intimate acoustic sessions to large-scale productions, 
                our flexible stage design accommodates various entertainment formats.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-purple-50 p-4 rounded-lg">
                  ...
                  <p className="text-gray-600 text-sm">Up to 500 seated / 800 standing</p>
                </div>
                
                <div className="bg-purple-50 p-4 rounded-lg">
                  <Clock className="h-6 w-6 text-purple-600 mb-2" />
                  <h4 className="font-semibold">Show Times</h4>
                  <p className="text-gray-600 text-sm">Evening performances 7:00 PM - 11:00 PM</p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {stageFeatures.map((feature, index) => {
              ...
              return (
                <div key={index} className="bg-white rounded-lg shadow-soft p-6 hover:shadow-lg transition-shadow">
      ...
      <section className="section-padding bg-gradient-to-r from-purple-50 to-blue-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="heading-secondary mb-4">Weekly Entertainment Schedule</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Join us for nightly entertainment featuring diverse performances, cultural shows, 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {weeklyEvents.map((event, index) => (
              <div key={index} className="bg-white rounded-lg shadow-soft p-6 hover:shadow-lg transition-shadow">
                ...
                <Button size="sm" className="w-full">Reserve Seats</Button>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="section-padding">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Our stage has welcomed renowned artists and cultural performers from Azerbaijan 
              and around the world, creating unforgettable evenings of entertainment.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {pastPerformers.map((performer, index) => (
              <div key={index} className="bg-white rounded-lg shadow-soft p-6 text-center">
                ...
                <p className="text-purple-600 font-semibold text-sm mb-2">{performer.type}</p>
                <p className="text-gray-600 text-sm mb-3">{performer.description}</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <div className="absolute bottom-6 left-6 text-white">
                ...
                <p className="text-gray-200">Private performances and custom events</p>
              </div>
            </div>
            
            <div>
              <h2 className="text-3xl font-bold mb-6">Private Events & Custom Performances</h2>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Our entertainment stage is available for private events, corporate functions, 
                weddings, and special celebrations. We can arrange custom performances, 
                coordinate with local and international artists, and create memorable events 
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Product launches, company celebrations, awards ceremonies</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Ceremony and reception entertainment with custom music</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Traditional celebrations and cultural exchange events</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Exclusive performances for groups and special occasions</p>
                  </div>
                </div>
              </div>
      ...
      <section className="section-padding bg-gradient-to-r from-purple-600 to-blue-600 text-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            <h2 className="text-4xl font-bold mb-4">Experience World-Class Entertainment</h2>
            <p className="text-xl text-purple-100 mb-8 leading-relaxed">
              Join us for unforgettable evenings of music, culture, and entertainment under the stars. 
              Reserve your seats for upcoming shows or inquire about hosting your own special event.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-white/10 rounded-lg p-6">
                ...
                <p className="text-purple-100 text-sm">Reserve premium seating for all performances</p>
              </div>
              
              <div className="bg-white/10 rounded-lg p-6">
                <Calendar className="h-8 w-8 text-white mx-auto mb-3" />
                <h3 className="font-semibold mb-2">Event Calendar</h3>
                <p className="text-purple-100 text-sm">View upcoming shows and special events</p>
              </div>
              
              <div className="bg-white/10 rounded-lg p-6">
                <Star className="h-8 w-8 text-white mx-auto mb-3" />
                <h3 className="font-semibold mb-2">VIP Packages</h3>
                <p className="text-purple-100 text-sm">Premium seating with dinner and drinks</p>
              </div>
            </div>
