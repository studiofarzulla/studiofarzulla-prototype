...
const restaurants = [
  {
    ...
    description: 'Experience international cuisine at its finest with our à la carte menu featuring dishes from around the world, complemented by stunning Caspian Sea views.',
    cuisine: 'International À La Carte',
    hours: '7:00 AM - 11:00 PM',
    capacity: 'Up to 120 guests',
    location: 'Main Building - Ground Floor',
    image: '/images/dining/terrace-restaurant.jpg',
    features: ['Sea View Terrace', 'International Menu', 'Wine Selection', 'Private Dining'],
    href: '/dining/the-terrace'
  },
  {
    name: 'Wild West Restaurant',
    description: 'Step into the American frontier with our Western-themed restaurant offering authentic American cuisine in a rustic, nostalgic atmosphere.',
    cuisine: 'American & Western',
    hours: '6:00 PM - 12:00 AM',
    capacity: 'Up to 80 guests',
    location: 'Building F - First Floor',
    image: '/images/dining/wild-west-restaurant.jpg',
    features: ['Western Theme', 'BBQ Specialties', 'Live Entertainment', 'Craft Cocktails'],
    href: '/dining/wild-west'
  },
  {
    name: 'The Shade Bar',
    description: 'Relax under our unique sail structure while enjoying refreshing beverages and light snacks with unobstructed views of the Caspian Sea.',
    ...
    features: ['Beachfront Location', 'Sunset Views', 'Cocktail Bar', 'Light Meals'],
    href: '/dining/shade-bar'
  },
  {
    name: 'Pool Bar',
    description: 'Cool off poolside with tropical drinks and casual dining while enjoying the perfect view of our outdoor swimming pool and recreational areas.',
...
const specialEvents: SpecialEvent[] = [
  {
    ...
    description: 'Join our sommelier for an exclusive wine tasting experience featuring selected wines from around the world, paired with gourmet appetizers.',
    type: 'culinary' ,
    date: 'Every Friday',
    time: '7:00 PM',
    duration: '2.5 hours',
    ...
    features: ['Professional Sommelier', '6 Wine Selection', 'Gourmet Pairings', 'Certificate'],
  ...
  },
  {
    ...
    description: 'Experience authentic American BBQ with live country music, line dancing, and all-you-can-eat barbecue feast in our Wild West themed restaurant.',
    type: 'entertainment' ,
    date: 'Every Saturday',
    time: '8:00 PM',
    duration: '4 hours',
    ...
    features: ['Live Country Music', 'Line Dancing', 'All-You-Can-Eat BBQ', 'Western Atmosphere'],
    booking_required: true,
    recurring: true
  },
  {
    ...
    description: 'Romantic beachfront dining experience with specially curated sunset menu, live acoustic music, and premium service under the stars.',
    type: 'seasonal' ,
    date: 'May - September',
    time: '7:30 PM',
    duration: '3 hours',
    ...
    features: ['Beachfront Setup', 'Live Acoustic Music', 'Romantic Atmosphere', 'Premium Service'],
    booking_required: true,
...
const features = [
  {
    ...
    description: 'À la carte menu featuring the finest dishes from around the world',
    color: 'from-orange-500 to-red-500'
  },
  {
    icon: IoWineOutline,
    title: 'Premium Beverages',
    description: 'Extensive wine collection and craft cocktails by expert mixologists',
  ...
  },
  {
    ...
    description: 'Refreshments and meals served directly to your poolside location',
  ...
  },
  {
    ...
    description: 'Corporate events, weddings, and special occasion catering services',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Create unforgettable memories with our bespoke private dining experiences. 
                Whether it's an intimate celebration, corporate event, or wedding reception, 
                our expert team will craft the perfect culinary experience.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Wedding Receptions</h4>
                    <p className="text-gray-600">Romantic beachfront ceremonies and elegant receptions</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-primary-500 rounded-full mt-3" />
                  <div>
                    ...
                    <p className="text-gray-600">Professional catering for conferences and business gatherings</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-primary-500 rounded-full mt-3" />
                  <div>
                    <h4 className="font-semibold text-gray-900">Special Celebrations</h4>
                    <p className="text-gray-600">Birthdays, anniversaries, and milestone celebrations</p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl shadow-soft p-8 text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">24/7 Room Service</h3>
              <p className="text-gray-600 mb-6">
                Enjoy our full dining menu from the comfort of your room, available around the clock for hotel guests.
              </p>
            ...
            <div className="bg-white rounded-2xl shadow-soft p-8 text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Dietary Accommodations</h3>
              <p className="text-gray-600 mb-6">
                Our chefs are happy to accommodate special dietary requirements including vegetarian, vegan, and gluten-free options.
              </p>
              <button className="text-primary-600 hover:text-primary-700 font-medium flex items-center mx-auto space-x-1">
            ...
            <div className="bg-white rounded-2xl shadow-soft p-8 text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Chef's Table Experience</h3>
              <p className="text-gray-600 mb-6">
                Book an exclusive chef's table experience with personalized menu creation and behind-the-scenes kitchen access.
              </p>
              <button className="text-primary-600 hover:text-primary-700 font-medium flex items-center mx-auto space-x-1">
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="text-white">
            ...
            <p className="text-xl text-primary-100 mb-8 max-w-2xl mx-auto">
              Make a reservation today and discover why our dining experiences are 
              celebrated by guests from around the world.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
