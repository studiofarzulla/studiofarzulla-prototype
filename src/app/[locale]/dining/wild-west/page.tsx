  ...
  appetizers: [
    {
      ...
      name: 'Buffalo Wings',
      description:
        'Crispy chicken wings tossed in authentic buffalo sauce, served with celery and blue cheese dip',
      price: '28 AZN',
      spicy: true,
      popular: true,
    },
    {
      ...
      description:
        'Crispy potato skins loaded with cheese, bacon bits, and green onions, served with sour cream',
      price: '24 AZN',
    },
    {
      id: '3',
      name: 'Cowboy Nachos',
      description:
        'House-made tortilla chips with melted cheese, jalapeños, beef chili, and all the fixings',
      price: '32 AZN',
      spicy: true,
    },
    {
  ...
  mains: [
    {
      ...
      description:
        '14oz ribeye steak grilled to perfection, served with mashed potatoes and grilled vegetables',
      price: '75 AZN',
      popular: true,
    },
    {
      ...
      description:
        'Slow-cooked pork ribs glazed with house BBQ sauce, served with coleslaw and baked beans',
      price: '58 AZN',
    },
    {
      id: '7',
      ...
      description:
        'Slow-cooked pulled pork with tangy BBQ sauce on a toasted brioche bun, served with fries',
      price: '35 AZN',
    },
    {
      id: '8',
      name: 'Texas Chili',
      description:
        'Hearty beef chili with kidney beans, served with cornbread and shredded cheese',
      price: '28 AZN',
      spicy: true,
    },
    {
      ...
      description:
        'Herb-marinated chicken breast with wild rice and seasonal vegetables',
      price: '42 AZN',
      dietary: ['gluten-free'],
    },
    {
      ...
      name: 'Veggie Burger',
      description:
        'House-made black bean and quinoa patty with avocado and sweet potato fries',
      price: '32 AZN',
      dietary: ['vegetarian'],
    },
  ],
  burgers: [
    {
      ...
      description:
        'Double beef patty with cheddar cheese, bacon, onion rings, and BBQ sauce',
      price: '45 AZN',
      popular: true,
    },
    {
      ...
      name: 'Rodeo Burger',
      description:
        'Beef patty with jalapeño jack cheese, guacamole, and chipotle mayo',
      price: '38 AZN',
      spicy: true,
    },
    {
      ...
      description:
        'Beef patty with American cheese, lettuce, tomato, and special sauce',
      price: '32 AZN',
    },
  ],
  desserts: [
    {
      ...
      description:
        'Traditional apple pie with vanilla ice cream and caramel sauce',
      price: '22 AZN',
      dietary: ['vegetarian'],
      popular: true,
    },
    {
      ...
      description:
        'Warm chocolate brownie with vanilla ice cream, whipped cream, and chocolate sauce',
      price: '24 AZN',
      dietary: ['vegetarian'],
    },
  ],
...
const specialHours = [
  {
    ...
    description:
      'Extended hours until midnight with special BBQ buffet and entertainment',
          ...
          <div className='max-w-4xl mx-auto text-center'>
            <div>
              ...
              <p className='text-lg text-gray-600 leading-relaxed mb-8'>
                Immerse yourself in the authentic atmosphere of the American
                frontier. Our Wild West Restaurant combines genuine Western
                décor with traditional American cuisine, creating an
                unforgettable dining experience that transports you to the days
                of cowboys, saloons, and frontier hospitality.
              </p>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            <div>
              <h2 className='text-3xl font-bold mb-6'>
                Authentic BBQ Smoking Process
              </h2>
              <p className='text-xl text-orange-100 mb-6 leading-relaxed'>
                Our BBQ meats are smoked low and slow for up to 12 hours using
                traditional American hardwoods, ensuring that authentic smoky
                flavor and tender texture that defines real barbecue.
              </p>
                ...
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-orange-100'>
                      Low temperature smoking for maximum tenderness
                    </p>
                  </div>
                </div>
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-orange-100'>
                      Hickory and oak for authentic smoky flavor
                    </p>
                  </div>
                </div>
                <div className='flex items-start space-x-3'>
              ...
              <div className='relative h-96 rounded-2xl overflow-hidden shadow-2xl'>
                ...
                <div className='absolute bottom-6 left-6 right-6'>
                  ...
                  <p className='text-sm text-gray-200'>
                    Our custom-built smoker maintains the perfect temperature
                    for authentic American barbecue, just like they do it in
                    Texas.
                  </p>
                </div>
              </div>
        ...
        <div className='container mx-auto px-4'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-600 max-w-3xl mx-auto'>
              Experience authentic Western entertainment with live country
              music, line dancing lessons, and special themed events that bring
              the spirit of the American frontier to life.
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            <div className='bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-8 text-center'>
              ...
              <p className='text-gray-600 mb-4'>
                Enjoy authentic country music performances every Friday and
                Saturday night featuring local and visiting artists.
              </p>
            ...
            <div className='bg-gradient-to-br from-red-50 to-orange-50 rounded-2xl p-8 text-center'>
              ...
              <p className='text-gray-600 mb-4'>
                Join our line dancing sessions every Saturday night with free
                lessons for beginners and fun for experienced dancers.
              </p>
            ...
            <div className='bg-gradient-to-br from-yellow-50 to-amber-50 rounded-2xl p-8 text-center'>
              ...
              <p className='text-gray-600 mb-4'>
                Special BBQ buffet nights featuring all-you-can-eat barbecue,
                live music, and authentic Western atmosphere.
              </p>
