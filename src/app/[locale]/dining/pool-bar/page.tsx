...
const menuItems = {
  poolsideCocktails: [
    {
      ...
      name: 'Pool Paradise',
      description:
        'Tropical rum blend with mango, coconut cream, and pineapple juice',
      price: '16 AZN',
      popular: true,
    },
    {
    ...
    },
    {
      ...
      description:
        'Classic frozen daiquiri available in strawberry, mango, or lime',
      price: '14 AZN',
      popular: true,
    },
    {
  ...
  snacks: [
    ...
    },
    {
      ...
      description:
        'Grilled chicken with cheese, peppers, and onions in crispy tortilla',
      price: '22 AZN',
    },
    {
      id: '8',
      name: 'Pool Nachos',
      description:
        'Crispy tortilla chips with cheese sauce, jalapeños, and sour cream',
      price: '18 AZN',
      dietary: ['vegetarian'],
    },
    {
      ...
      description:
        'Crisp romaine lettuce with parmesan cheese and garlic croutons',
      price: '20 AZN',
      dietary: ['vegetarian'],
    },
    {
      ...
      name: 'Fish & Chips',
      description:
        'Beer-battered fish fillet with golden fries and tartar sauce',
      price: '28 AZN',
    },
  ],
  refreshments: [
    {
      ...
      description:
        'Seasonal selection of tropical and local fruits served chilled',
      price: '16 AZN',
    ...
    },
    {
      ...
      description:
        'Acai and banana blend topped with granola and fresh berries',
      price: '18 AZN',
      dietary: ['vegan'],
    },
  ],
          ...
          <div className='max-w-4xl mx-auto text-center'>
            <div>
              ...
              <p className='text-lg text-gray-600 leading-relaxed mb-8'>
                The Pool Bar is your gateway to the perfect pool day experience.
                Whether you're cooling off after a swim, enjoying a sunny
                afternoon with friends, or treating the kids to ice cream, our
                poolside location offers everything you need for a refreshing
                and enjoyable time by the water.
              </p>
              ...
              <div className='grid grid-cols-1 md:grid-cols-4 gap-6'>
                <div className='bg-white rounded-lg p-6 shadow-soft'>
                  ...
                  <div className='text-sm text-gray-600'>
                    Perfect spot to watch pool activities
                  </div>
                </div>
                <div className='bg-white rounded-lg p-6 shadow-soft'>
                  ...
                  <div className='text-sm text-gray-600'>
                    Drinks delivered to your lounger
                  </div>
                </div>
                <div className='bg-white rounded-lg p-6 shadow-soft'>
                  <div className='text-2xl mb-2'>🍦</div>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            <div>
              ...
              <p className='text-xl text-blue-100 mb-6 leading-relaxed'>
                Don't want to leave your comfortable spot by the pool? No
                problem! Our friendly staff will bring your drinks and snacks
                directly to your pool lounger, ensuring you can enjoy
                uninterrupted relaxation in the sun.
              </p>
                ...
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-blue-100'>
                      Orders delivered directly to your pool chair
                    </p>
                  </div>
                </div>
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-blue-100'>
                      Easy-to-use poolside ordering system
                    </p>
                  </div>
                </div>
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-blue-100'>
                      Fresh towels available with food service
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className='relative h-96 rounded-2xl overflow-hidden shadow-2xl'>
                ...
                <div className='absolute bottom-6 left-6 right-6'>
                  ...
                  <p className='text-sm text-gray-200'>
                    Relax and enjoy as our staff takes care of all your poolside
                    needs, from refreshing drinks to comfortable amenities.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className='container mx-auto px-4'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-600 max-w-3xl mx-auto'>
              The Pool Bar caters to guests of all ages with special
              family-friendly features, kids' options, and activities to keep
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
            <div className='bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl p-6 text-center'>
              ...
              <p className='text-gray-600 text-sm'>
                Special menu items designed for children with healthy options
            ...
            <div className='bg-gradient-to-br from-pink-50 to-red-50 rounded-2xl p-6 text-center'>
              ...
              <p className='text-gray-600 text-sm'>
                Premium ice cream selection with various flavors and fun
                toppings for all ages.
              </p>
            </div>
            ...
            <div className='bg-gradient-to-br from-green-50 to-teal-50 rounded-2xl p-6 text-center'>
              ...
              <p className='text-gray-600 text-sm'>
                Fresh fruit smoothies, natural juices, and nutritious snacks for
            ...
            <div className='bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-6 text-center'>
              ...
              <p className='text-gray-600 text-sm'>
                Water volleyball, pool basketball, and other fun activities to
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            ...
            <div>
              ...
              <p className='text-lg text-gray-600 mb-6 leading-relaxed'>
                The Pool Bar is more than just a refreshment stop - it's the
                heart of our pool area social experience. With comfortable
                seating, excellent service, and a fun atmosphere, it's where
                memories are made.
              </p>
              ...
              <div className='space-y-4 mb-8'>
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600'>
                      Best views of the pool and surrounding gardens
                    </p>
                  </div>
                </div>
                <div className='flex items-start space-x-3'>
                ...
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600'>
                      Meet other guests and enjoy the vibrant atmosphere
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className='max-w-3xl mx-auto text-center'>
            <div>
              ...
              <p className='text-lg text-gray-600 mb-8'>
                No reservations needed - just grab a spot by the pool and let us
                take care of everything else. Pool towels, comfortable loungers,
                and refreshing service await!
              </p>
              ...
              <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mb-8'>
                ...
                <div className='bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg p-6'>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Towels, loungers, and umbrellas available
                  </p>
                </div>
                <div className='bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg p-6'>
                  <h4 className='font-semibold text-gray-900 mb-2'>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Pool parties and celebrations welcome
                  </p>
                </div>
              </div>
