...
const menuItems = {
  breakfast: [
    {
      ...
      description:
        'Fresh croissants, artisan breads, seasonal fruits, cheeses, and cold cuts with premium coffee',
      price: '35 AZN',
      dietary: ['vegetarian'],
      popular: true,
    },
    {
      ...
      name: 'Eggs Benedict',
      description:
        'Poached eggs, Canadian bacon, hollandaise sauce on toasted English muffins',
      price: '28 AZN',
    },
    {
      id: '3',
      ...
      description:
        'Traditional Turkish scrambled eggs with tomatoes, peppers, and herbs',
      price: '24 AZN',
      dietary: ['vegetarian'],
      spicy: true,
    },
    {
      ...
      description:
        'Seasonal selection of local and tropical fruits with Greek yogurt and honey',
      price: '18 AZN',
  ...
  lunch: [
    {
      ...
      description:
        'Fresh salmon fillet with Mediterranean vegetables and lemon herb butter',
      price: '48 AZN',
      dietary: ['gluten-free'],
      popular: true,
    },
    {
      ...
      description:
        'Premium beef tenderloin with roasted potatoes and seasonal vegetables',
      price: '65 AZN',
      dietary: ['gluten-free'],
    },
    {
      ...
      description:
        'House-made pasta with sun-dried tomatoes, olives, capers, and fresh basil',
      price: '32 AZN',
      dietary: ['vegetarian'],
    },
    {
  ...
  dinner: [
    {
      ...
      description:
        'Premium local caviar served with traditional accompaniments and blinis',
      price: '120 AZN',
      popular: true,
    },
    {
      ...
      description:
        'Whole lobster with cognac cream sauce, gruyere cheese, and aromatic herbs',
      price: '85 AZN',
    },
    {
      id: '11',
    ...
    },
    {
      ...
      description:
        'Five-course seasonal vegetarian menu showcasing local produce',
      price: '68 AZN',
      dietary: ['vegetarian'],
    },
  ],
  desserts: [
    ...
    },
    {
      ...
      description:
        'Warm chocolate soufflé with vanilla ice cream (20 minutes preparation)',
      price: '28 AZN',
      dietary: ['vegetarian'],
    },
  ],
...
const specialHours = [
  {
    ...
    description:
      'Extended dinner service until midnight for wine tasting events',
          ...
          <div className='max-w-4xl mx-auto text-center'>
            <div>
              ...
              <p className='text-lg text-gray-600 leading-relaxed mb-8'>
                The Terrace Restaurant stands as our flagship dining venue,
                offering an unparalleled culinary journey that celebrates
                international flavors while embracing the beauty of our
                beachfront location. Every meal becomes a memorable experience
                with our carefully curated à la carte menu and stunning
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            <div>
              ...
              <p className='text-lg text-gray-600 mb-6 leading-relaxed'>
                Our extensive wine collection features over 200 carefully
                selected wines from renowned vineyards around the world. From
                crisp whites to full-bodied reds, our sommelier will help you
                find the perfect pairing for your meal.
              </p>
                ...
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600'>
                      Wines from France, Italy, Spain, California, and beyond
                    </p>
                  </div>
                </div>
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600'>
                      Professional wine pairing recommendations and tastings
                    </p>
                  </div>
                </div>
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600'>
                      Signature cocktails and premium spirits selection
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className='relative h-96 rounded-2xl overflow-hidden shadow-soft'>
                ...
                <div className='absolute bottom-6 left-6 right-6 text-white'>
                  ...
                  <p className='text-sm opacity-90'>
                    Join us every Friday for our weekly wine tasting experience
                    featuring six premium wines paired with gourmet appetizers.
                  </p>
                </div>
              </div>
            </div>
