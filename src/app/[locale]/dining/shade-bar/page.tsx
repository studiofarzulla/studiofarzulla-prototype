  ...
  cocktails: [
    {
      id: '1',
      name: 'Caspian Sunset',
      description: 'Signature cocktail with vodka, passion fruit, lime juice, and a splash of cranberry',
      price: '18 AZN',
      popular: true
    },
    {
      id: '2',
      name: 'Beach Breeze',
      description: 'Refreshing rum-based cocktail with coconut cream, pineapple juice, and blue curaçao',
      price: '16 AZN'
    },
    {
      id: '3',
      name: 'Sea Salt Margarita',
      description: 'Classic margarita with premium tequila, fresh lime, and sea salt rim',
      price: '20 AZN',
      popular: true
    },
    {
      id: '4',
      name: 'Mojito Royale',
      description: 'Traditional mojito with fresh mint, lime, and a splash of prosecco',
      price: '17 AZN'
    },
    {
      id: '5',
      name: 'Virgin Piña Colada',
      description: 'Non-alcoholic blend of coconut cream, pineapple juice, and crushed ice',
      price: '12 AZN',
  ...
  lightBites: [
    {
      ...
      description: 'Selection of hummus, olives, feta cheese, sun-dried tomatoes, and pita bread',
      price: '32 AZN',
      dietary: ['vegetarian'] ,
      popular: true
    },
    {
      ...
      description: 'Grilled shrimp, calamari rings, and fish cakes with lemon aioli',
      price: '45 AZN'
    },
    {
      id: '8',
      name: 'Beach Club Sandwich',
      description: 'Grilled chicken, bacon, avocado, and fresh vegetables on toasted bread',
      price: '28 AZN'
    },
    {
      id: '9',
      name: 'Tropical Fruit Bowl',
      description: 'Fresh seasonal fruits with honey yogurt dip and mint garnish',
      price: '18 AZN',
    ...
    },
    {
      ...
      description: 'Mediterranean salad with grilled halloumi, cherry tomatoes, and herb dressing',
      price: '24 AZN',
      dietary: ['vegetarian'] 
    }
  ],
  beverages: [
    {
      ...
      description: 'Served directly from the coconut with ice and tropical fruit garnish',
      price: '15 AZN',
    ...
    },
    {
      ...
      description: 'Cold brew, iced latte, or frappé with various flavor options',
      price: '12 AZN'
    },
    {
      id: '14',
      name: 'Premium Juice Selection',
      description: 'Freshly squeezed orange, grapefruit, apple, or seasonal fruit juices',
      price: '10 AZN',
      dietary: ['vegan', 'gluten-free'] 
    }
  ]
...
const galleryImages = [
  {
    ...
    description: 'Distinctive sail canopy providing shade over beachfront seating'
  },
  {
    id: '2',
  ...
  return (
    <div className="min-h-screen">
      ...
      <RestaurantHero
        ...
        features={['Beachfront Location', 'Sail Canopy Design', 'Sunset Views', 'Cocktail Bar', 'Light Meals']}
      />
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div>
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-8">
                The Shade Bar offers the ultimate beachfront experience under our iconic sail structure. 
                Whether you're looking for a refreshing midday drink, a romantic sunset cocktail, or 
                late-night entertainment, our beach bar provides the perfect setting with unobstructed 
                views of the Caspian Sea and a relaxed, tropical atmosphere.
              </p>
              
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div className="bg-white rounded-lg p-6 shadow-soft">
                  <div className="text-2xl mb-2">🌅</div>
                  <div className="font-semibold text-gray-900 mb-1">Sunset Views</div>
                  <div className="text-sm text-gray-600">Best sunset spot at the resort</div>
                </div>
                <div className="bg-white rounded-lg p-6 shadow-soft">
                  <div className="text-2xl mb-2">⛵</div>
                  <div className="font-semibold text-gray-900 mb-1">Sail Canopy</div>
                  <div className="text-sm text-gray-600">Unique architectural feature</div>
                </div>
                <div className="bg-white rounded-lg p-6 shadow-soft">
                  <div className="text-2xl mb-2">🍹</div>
                  <div className="font-semibold text-gray-900 mb-1">Craft Cocktails</div>
                  <div className="text-sm text-gray-600">Premium spirits & fresh ingredients</div>
                </div>
                <div className="bg-white rounded-lg p-6 shadow-soft">
                  <div className="text-2xl mb-2">🏖️</div>
                  <div className="font-semibold text-gray-900 mb-1">Beach Access</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-orange-100 mb-6 leading-relaxed">
                ...
                The Shade Bar. Our prime beachfront location offers unobstructed views of the 
                horizon, making every evening a spectacular show of colors and tranquility.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-white">Golden Hour Specials</h4>
                    <p className="text-orange-100">Special sunset cocktails available 6:30 PM - 8:00 PM</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-yellow-300 rounded-full mt-3" />
                  <div>
                    ...
                    <p className="text-orange-100">Reserved sunset seating available with advance booking</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-yellow-300 rounded-full mt-3" />
                  <div>
                    <h4 className="font-semibold text-white">Photo Opportunities</h4>
                    <p className="text-orange-100">Perfect Instagram moments with stunning backdrops</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="relative h-96 rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <h3 className="text-xl font-bold mb-2 text-white">Daily Sunset Show</h3>
                  <p className="text-sm text-gray-200">
                    Every evening offers a unique sunset experience, with colors reflecting 
                    off the calm waters of the Caspian Sea.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Beach Bar Features & Ambiance</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our unique design and prime beachfront location create the perfect atmosphere 
              for relaxation and socializing by the sea.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white rounded-2xl shadow-soft p-8">
                ...
                <p className="text-gray-600 mb-4">
                  ...
                  perfectly timed for the golden hour before sunset.
                </p>
              ...
              <div className="bg-white rounded-2xl shadow-soft p-8">
                ...
                <p className="text-gray-600 mb-4">
                  ...
                  creating the perfect atmosphere for evening socializing.
                </p>
          ...
          <div className="max-w-2xl mx-auto text-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                ...
                For special events or large groups, feel free to contact us in advance.
              </p>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="bg-gradient-to-br from-blue-50 to-teal-50 rounded-lg p-6">
                  <h4 className="font-semibold text-gray-900 mb-2">Walk-ins Welcome</h4>
                  <p className="text-gray-600 text-sm">No reservation needed for regular seating</p>
                </div>
                <div className="bg-gradient-to-br from-blue-50 to-teal-50 rounded-lg p-6">
                  <h4 className="font-semibold text-gray-900 mb-2">Group Bookings</h4>
                  <p className="text-gray-600 text-sm">Contact us for parties of 8 or more</p>
                </div>
              </div>
