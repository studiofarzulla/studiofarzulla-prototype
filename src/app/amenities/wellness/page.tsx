  ...
  const spaServices = [
    {
      ...
      duration: "90 minutes",
      price: "$120",
      description: "Therapeutic massage using local sea minerals and essential oils"
    },
    {
  ...
  return (
    <div className='min-h-screen'>
      ...
      <section className="section-padding">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <h2 className="text-3xl font-bold mb-6">State-of-the-Art Fitness Center</h2>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Our modern fitness center features the latest Technogym equipment, spacious workout areas, 
                and professional training facilities. Whether you're maintaining your routine or starting 
                a new fitness journey, our center provides everything you need.
              </p>
              <p className="text-gray-600 mb-8 leading-relaxed">
                With 24/7 access for hotel guests, climate control, entertainment systems, and dedicated 
                areas for different workout styles, you'll find the perfect environment to achieve your 
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-green-50 p-4 rounded-lg">
                  ...
                  <p className="text-gray-600 text-sm">Latest Technogym machines and free weights</p>
                </div>
                
                <div className="bg-green-50 p-4 rounded-lg">
                  <Users className="h-6 w-6 text-green-600 mb-2" />
                  <h4 className="font-semibold">Personal Training</h4>
                  <p className="text-gray-600 text-sm">Certified trainers available by appointment</p>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Experience the therapeutic benefits of our traditional steam and dry sauna facilities, 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg shadow-soft overflow-hidden">
              ...
              <div className="p-6">
                <p className="text-gray-600 mb-4">
                  Traditional steam room with eucalyptus-infused steam for deep cleansing and relaxation.
                </p>
            ...
            <div className="bg-white rounded-lg shadow-soft overflow-hidden">
              ...
              <div className="p-6">
                <p className="text-gray-600 mb-4">
                  Authentic Finnish-style dry sauna with premium wood construction and controlled heating.
                </p>
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div>
                    <p className="text-sm text-gray-600">Temperature</p>
      ...
      <section className="section-padding">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="heading-secondary mb-4">Professional Spa Services</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Indulge in our signature spa treatments performed by certified therapists using 
              premium products and techniques for ultimate relaxation and rejuvenation.
            </p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            {spaServices.map((service, index) => (
              <div key={index} className="bg-white rounded-lg shadow-soft p-6 border-l-4 border-green-500">
          ...
          <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-2xl p-8">
            <div className="text-center mb-8">
              <h3 className="text-3xl font-bold mb-4">Spa Amenities & Features</h3>
              <p className="text-lg text-gray-600">Complete wellness experience with premium facilities</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-soft text-center">
                ...
                <p className="text-gray-600 text-sm">Quiet space for pre and post-treatment relaxation</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-soft text-center">
                <Leaf className="h-10 w-10 text-green-600 mx-auto mb-3" />
                <h4 className="font-semibold mb-2">Organic Products</h4>
                <p className="text-gray-600 text-sm">Premium natural and organic skincare products</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-soft text-center">
                <Star className="h-10 w-10 text-green-600 mx-auto mb-3" />
                <h4 className="font-semibold mb-2">Private Suites</h4>
                <p className="text-gray-600 text-sm">Individual and couples treatment rooms available</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding bg-gradient-to-r from-green-600 to-blue-600 text-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold mb-6">Your Wellness Journey Awaits</h2>
              <p className="text-xl text-green-100 mb-8 leading-relaxed">
                Transform your stay into a wellness retreat with our comprehensive facilities and services. 
                From energizing workouts to relaxing spa treatments, create your perfect wellness experience.
              </p>
            ...
            <div className="bg-white/10 rounded-2xl p-8">
              <h3 className="text-2xl font-bold mb-6">Wellness Package Deals</h3>
              <div className="space-y-6">
                <div className="border-l-4 border-white pl-4">
                  <h4 className="font-semibold text-lg">Daily Wellness Pass</h4>
                  <p className="text-green-100 mb-2">Full access to fitness center and sauna facilities</p>
                  <p className="text-2xl font-bold">$35/day</p>
                </div>
                
                <div className="border-l-4 border-white pl-4">
                  <h4 className="font-semibold text-lg">Spa & Sauna Combo</h4>
                  <p className="text-green-100 mb-2">60-minute massage plus sauna session</p>
                  <p className="text-2xl font-bold">$110</p>
                </div>
                
                <div className="border-l-4 border-white pl-4">
                  <h4 className="font-semibold text-lg">Weekly Wellness Program</h4>
                  <p className="text-green-100 mb-2">Complete wellness package for extended stays</p>
