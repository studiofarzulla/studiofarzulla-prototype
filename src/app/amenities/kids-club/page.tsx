...
export const metadata: Metadata = {
  ...
  description: 'Safe, fun, and educational environment for children with supervised activities, educational programs, and professional childcare services.',
};
...
export default function KidsClubPage() {
  ...
  const dailySchedule = [
    { time: "9:00 AM", activity: "Welcome & Free Play", location: "Indoor Play Area" },
    { time: "10:00 AM", activity: "Arts & Crafts Session", location: "Craft Room" },
    { time: "11:00 AM", activity: "Pool Time & Swimming", location: "Kids Pool" },
    { time: "12:00 PM", activity: "Lunch Break", location: "Kids Dining Area" },
    { time: "1:00 PM", activity: "Story Time & Rest", location: "Quiet Room" },
    { time: "2:30 PM", activity: "Beach Activities", location: "Private Beach" },
    { time: "4:00 PM", activity: "Educational Games", location: "Learning Center" },
    { time: "5:00 PM", activity: "Creative Time", location: "Activity Room" },
    { time: "6:00 PM", activity: "Evening Wind Down", location: "Indoor Play Area" }
  ];
  ...
  return (
    <div className='min-h-screen'>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            <div className="lg:col-span-2">
              <h2 className="text-3xl font-bold mb-6">Child Safety & Professional Care</h2>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Our Kids Club is designed with child safety as the top priority. All staff members are 
                certified in childcare, first aid, and child protection. The facility features secure 
                access, age-appropriate equipment, and constant supervision to ensure your child's 
                safety and wellbeing.
              </p>
              <p className="text-gray-600 mb-8 leading-relaxed">
                We maintain low child-to-staff ratios, ensuring personalized attention for each child. 
                Our structured activities promote learning, creativity, and social development while 
                providing hours of fun and engagement.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="bg-orange-50 p-6 rounded-lg">
                  ...
                  <p className="text-gray-600 text-sm">
                    All childcare professionals certified in first aid and child development
                  </p>
                </div>
                ...
                <div className="bg-orange-50 p-6 rounded-lg">
                  ...
                  <p className="text-gray-600 text-sm">
                    Warm, welcoming atmosphere that feels like a home away from home
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-orange-500 to-yellow-500 text-white rounded-lg p-6">
                ...
                <p className="text-orange-100 text-sm">
                  Programs tailored to different developmental stages and interests
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Our programs are carefully designed for different age groups, ensuring activities 
              are developmentally appropriate and engaging for each child.
            </p>
          </div>
      ...
      <section className="section-padding">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              A structured day filled with fun, learning, and adventure designed to keep 
              children engaged and happy throughout their stay.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-lg shadow-soft overflow-hidden">
              <div className="bg-gradient-to-r from-orange-500 to-yellow-500 p-6 text-white">
                ...
                <p className="text-orange-100">Activities may vary based on weather and group preferences</p>
              </div>
              
              <div className="p-6">
                <div className="space-y-4">
                  {dailySchedule.map((item, index) => (
                    <div key={index} className="flex items-center p-4 bg-gray-50 rounded-lg hover:bg-orange-50 transition-colors">
      ...
      <section className="section-padding bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="heading-secondary mb-4">Special Programs & Services</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Additional services and special programs to make your family's stay extra special
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white rounded-lg shadow-soft p-6 text-center">
              ...
              <p className="text-gray-600 text-sm">
                Professional swimming instruction for all skill levels in our dedicated kids pool
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-soft p-6 text-center">
              ...
              <p className="text-gray-600 text-sm">
                Fun learning sessions covering science, nature, and local culture
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-soft p-6 text-center">
              ...
              <p className="text-gray-600 text-sm">
                Creative projects and artistic expression with professional art supplies
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="bg-gradient-to-r from-orange-600 to-yellow-600 rounded-2xl p-8 lg:p-12 text-white">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-3xl font-bold mb-4">Peace of Mind for Parents</h2>
                <p className="text-lg text-orange-100 mb-6">
                  Enjoy your vacation knowing your children are in safe, caring hands with 
                  our professional childcare team and comprehensive safety measures.
                </p>
                
                <div className="space-y-4 mb-8">
                  <div className="flex items-center">
                    <div className="w-2 h-2 bg-white rounded-full mr-3" />
                    <span>Regular updates and photo sharing throughout the day</span>
                  </div>
                  <div className="flex items-center">
                    <div className="w-2 h-2 bg-white rounded-full mr-3" />
              ...
              <div className="text-center">
                ...
                <div className="mt-8 text-center">
                  <p className="text-orange-100 text-sm mb-2">Questions about our Kids Club?</p>
                  <p className="font-semibold">Call: +994 12 123 4567</p>
                  <p className="text-orange-100 text-sm">kidclub@crescentbeachhotel.com</p>
                </div>
              </div>
            </div>
          </div>
