...
const instagramPosts: InstagramPost[] = [
  {
    ...
    comments: 47,
    caption:
      'Golden hour at our infinity pool 🌅 #CrescentBeachHotel #CaspianSea',
  },
  {
    id: '2',
  ...
  },
  {
    ...
    comments: 29,
    caption:
      'Traditional Azerbaijani performance on our entertainment stage 🎭',
  },
  {
    id: '6',
      ...
      <div className='container mx-auto px-4'>
        ...
        <div className='text-center mb-12'>
          ...
          <p className='text-lg text-gray-600 max-w-2xl mx-auto mb-6'>
            Stay connected with The Crescent Beach Hotel through our Instagram
            feed. Discover daily moments of luxury, breathtaking views, and
