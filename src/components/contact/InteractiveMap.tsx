  ...
  const transportOptions = [
    {
      ...
      time: '45 minutes',
      distance: '35 km',
      description: 'Take the highway towards city center, then follow coastal road',
        ...
        {activeTab === 'map' ? (
            ...
            <div className="relative aspect-video bg-gray-100 rounded-lg overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-primary-100 to-accent-100 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-primary-800 font-semibold mb-2">Interactive Map</p>
          ...
          >
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <h3 className="font-semibold text-blue-900 mb-2">Transportation Services</h3>
              <ul className="text-sm text-blue-800 space-y-1">
                <li>• Free airport shuttle service (advance booking required)</li>
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              <h3 className="font-semibold text-green-900 mb-3">Nearby Landmarks</h3>
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4">
              <h3 className="font-semibold text-red-900 mb-2">Need Help Finding Us?</h3>
              <p className="text-sm text-red-800 mb-3">
                Our concierge team is available 24/7 to assist with directions and transportation.
              </p>
              <a
                href={`tel:${CONTACT_INFO.phone}`}
