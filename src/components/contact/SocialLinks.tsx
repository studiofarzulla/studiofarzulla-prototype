...
const SOCIAL_PLATFORMS: SocialPlatform[] = [
  {
    ...
    followers: '12.5K',
    description: 'Daily photos of our beautiful resort, guest experiences, and behind-the-scenes content',
    posts: 1247
  },
  {
    name: 'Facebook',
    ...
    followers: '8.2K',
    description: 'Hotel updates, event announcements, guest reviews, and community engagement',
    posts: 892
  },
  {
    name: 'YouTube',
    ...
    followers: '3.1K',
    description: 'Virtual tours, guest testimonials, event highlights, and promotional videos',
    posts: 67
  },
  {
    name: 'LinkedIn',
    ...
    followers: '2.8K',
    description: 'Business updates, corporate events, partnerships, and professional networking',
    posts: 342
  },
  {
    name: 'TikTok',
    ...
    followers: '5.6K',
    description: 'Fun, creative content showcasing hotel life, trends, and guest experiences',
    posts: 156
  },
  {
    name: 'Twitter',
    ...
    followers: '4.3K',
    description: 'Real-time updates, customer service, industry news, and quick announcements',
    posts: 1892
  }
];
...
export default function SocialLinks({ className, showStats = true }: SocialLinksProps) {
    ...
    <div className={cn('space-y-8', className)}>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {SOCIAL_PLATFORMS.map((platform, index) => (
            ...
            >
              {/* Background Gradient */}
              <div className={cn('absolute inset-0 opacity-5 group-hover:opacity-10 transition-opacity bg-gradient-to-br', platform.color)} />
              ...
              <div className="relative p-6">
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <div className={cn('w-12 h-12 rounded-lg flex items-center justify-center bg-gradient-to-br text-white shadow-lg', platform.color)}>
                ...
                <div className="flex items-center justify-between">
                  <span className={cn('inline-block px-3 py-1 text-xs font-medium rounded-full text-white bg-gradient-to-r', platform.color)}>
                    Follow Us
                  </span>
      ...
      <div className="bg-gradient-to-r from-primary-500 to-accent-500 rounded-2xl p-6 text-white">
        ...
        <p className="text-white/90 mb-4">
          Tag us in your posts and use our hashtags to be featured on our social media!
        </p>
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6">
        ...
        <p className="text-gray-600 mb-6">
          See what our guests are sharing about their experiences at The Crescent Beach Hotel.
        </p>
      ...
      <div className="bg-gray-50 rounded-2xl p-6">
        <h3 className="text-xl font-bold text-gray-900 mb-4">Latest from Our Feeds</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg p-4">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <h4 className="font-semibold text-gray-900">@crescentbeachhotel</h4>
                <p className="text-xs text-gray-500">2 hours ago</p>
              </div>
            </div>
            <p className="text-sm text-gray-700 mb-3">
              Sunset dinner at our terrace restaurant 🌅 Book your table for tonight! #CrescentBeachHotel
            </p>
          ...
          <div className="bg-white rounded-lg p-4">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <h4 className="font-semibold text-gray-900">The Crescent Beach Hotel</h4>
                <p className="text-xs text-gray-500">5 hours ago</p>
              </div>
            </div>
            <p className="text-sm text-gray-700 mb-3">
              Join us for our weekly wine tasting event every Friday evening. Limited seats available!
            </p>
