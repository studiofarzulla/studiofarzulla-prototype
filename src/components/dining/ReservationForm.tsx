...
import { IoCalendarOutline, IoTimeOutline, IoPeopleOutline, IoPersonOutline, IoCallOutline, IoMailOutline } from 'react-icons/io5';
...
export default function ReservationForm({ restaurantName, onSubmit }: ReservationFormProps) {
  ...
  if (submitted) {
    return (
      ...
      >
        ...
        <h3 className="text-2xl font-bold text-gray-900 mb-4">Reservation Confirmed!</h3>
        <p className="text-gray-600 mb-6">
          Your table at {restaurantName} has been reserved for {formData.guests} guests on{' '}
  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        <h3 className="text-2xl font-bold text-gray-900 mb-2">Reserve Your Table</h3>
        <p className="text-gray-600">Book your dining experience at {restaurantName}</p>
      </div>
      ...
      <div className="mt-6 text-center">
        <p className="text-sm text-gray-500">
          ...
          <a href="tel:+994123456789" className="text-primary-600 hover:text-primary-700 font-medium">
            +994 12 345 6789
          </a>
        </p>
      </div>
