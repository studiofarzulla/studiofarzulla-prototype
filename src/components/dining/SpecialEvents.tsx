...
import { IoCalendarOutline, IoTimeOutline, IoLocationOutline, IoPeopleOutline, IoTicketOutline, IoArrowForwardOutline } from 'react-icons/io5';
      ...
      <div className="container mx-auto px-4">
            ...
            >
              ...
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute top-4 left-4">
                  <span className={`px-3 py-1 text-xs font-semibold text-white rounded-full bg-gradient-to-r ${eventTypeColors[event.type]}`}>
        ...
        >
          <div className="p-8 text-white text-center">
            <h3 className="text-2xl font-bold mb-4">Planning a Private Event?</h3>
            <p className="text-primary-100 mb-6 max-w-2xl mx-auto">
              From intimate dinner parties to corporate celebrations, our expert team will create 
              a memorable experience tailored to your specific needs and preferences.
            </p>
