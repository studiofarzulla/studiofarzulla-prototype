...
import { IoTrophyOutline, IoRestaurantOutline, IoSchoolOutline } from 'react-icons/io5';
    ...
    >
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Meet Our Executive Chef</h2>
            ...
            {philosophy && (
              <div className="bg-white p-6 rounded-xl shadow-soft border-l-4 border-primary-500">
                <h4 className="text-lg font-semibold text-gray-900 mb-3">Culinary Philosophy</h4>
            ...
            {signature_dishes.length > 0 && (
              <div>
                <h4 className="text-lg font-semibold text-gray-900 mb-3">Signature Dishes</h4>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {signature_dishes.map((dish, index) => (
                    ...
                    >
                      <span className="text-primary-700 font-medium">{dish}</span>
                    </div>
                  ))}
                </div>
              </div>
