    ...
    <section className='relative h-screen overflow-hidden'>
      ...
      <div className='relative z-10 h-full flex items-center justify-center'>
        <div className='container mx-auto px-4 text-center text-white'>
          <div key={currentSlide} className='max-w-4xl mx-auto'>
            ...
            <p className='text-base md:text-lg text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed'>
              Experience unparalleled luxury on the pristine shores of the
              Caspian Sea. Where timeless elegance meets modern comfort across
              nine magnificent buildings, creating an unforgettable beachfront
              sanctuary.
            </p>
          </div>
        </div>
