...
const MOCK_VIDEOS: VideoItem[] = [
  {
    ...
    description: 'Take a comprehensive virtual tour of our luxury hotel facilities',
  ...
  },
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1578774204375-39ab30d2ebb1?w=600',
    videoUrl: 'https://sample-videos.com/zip/10/mp4/SampleVideo_720x480_1mb.mp4',
    duration: '2:30',
    category: 'Rooms'
  },
  {
    ...
    description: 'Meet our executive chef and explore our award-winning restaurants',
    thumbnail: 'https://images.unsplash.com/photo-1544963650-2bf9e2c36fb4?w=600',
    videoUrl: 'https://sample-videos.com/zip/10/mp4/SampleVideo_720x480_1mb.mp4',
    duration: '4:20',
    category: 'Dining'
  },
...
export default function VideoGallery({ videos = MOCK_VIDEOS }: VideoGalleryProps) {
    ...
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-primary-500 to-accent-500 rounded-2xl p-8 text-white text-center">
        ...
        <p className="text-lg mb-6 opacity-90">
          Experience our luxury hotel from the comfort of your home with our immersive 360° virtual tour
        </p>
