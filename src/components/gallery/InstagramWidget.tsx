...
import { IoLogoInstagram, IoHeart, IoArrowForward, IoRefresh } from 'react-icons/io5';
...
const MOCK_POSTS: InstagramPost[] = [
  {
    ...
    caption: 'Sunset views from our terrace restaurant 🌅 #CrescentBeachHotel #Azerbaijan',
    likes: 234,
  ...
  {
    id: '2',
    imageUrl: 'https://images.unsplash.com/photo-1578774204375-39ab30d2ebb1?w=400',
    caption: 'Luxury suite with ocean views 🏖️ Book your stay today! #LuxuryTravel',
    likes: 189,
  ...
  },
  {
    ...
    caption: 'Fresh seafood at our beachfront restaurant 🦐 #FreshSeafood #CaspianSea',
    likes: 156,
  ...
  },
  {
    ...
    caption: 'Wedding celebration at The Crescent Beach Hotel 💍✨ #WeddingVenue',
    likes: 412,
                ...
                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/40 transition-all duration-300 flex items-center justify-center">
                  <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-white text-center p-4">
                    <div className="flex items-center justify-center gap-2 mb-2">
                      ...
                      <span className="font-semibold">{formatLikes(post.likes)}</span>
                    </div>
