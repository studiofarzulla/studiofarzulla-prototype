        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16'>
          <div>
            <h2 className='heading-secondary mb-6'>
              Private Caspian Sea Beach
            </h2>
            <p className='text-lg text-gray-600 mb-6 leading-relaxed'>
              Experience the ultimate beachfront luxury with exclusive access to
              our pristine private beach on the Caspian Sea. Enjoy crystal-clear
              waters, premium beach services, and a variety of water activities
              in complete privacy and comfort.
            </p>
            <div className='space-y-4 mb-8'>
              <div className='flex items-center'>
                <Waves className='h-5 w-5 text-primary-600 mr-3' />
                <span className='text-gray-700'>
                  500 meters of private shoreline
                </span>
              </div>
              <div className='flex items-center'>
                <Users className='h-5 w-5 text-primary-600 mr-3' />
                <span className='text-gray-700'>
                  Dedicated beach staff and lifeguard
                </span>
              </div>
              <div className='flex items-center'>
                <Umbrella className='h-5 w-5 text-primary-600 mr-3' />
                <span className='text-gray-700'>
                  Complimentary sunbeds and umbrellas
                </span>
              </div>
            </div>
        ...
        <div className='mb-16'>
          <div className='text-center mb-12'>
            <h3 className='text-3xl font-bold mb-4'>
              Beach Activities & Services
            </h3>
            <p className='text-lg text-gray-600 max-w-2xl mx-auto'>
              From relaxation to adventure, our beach offers something for every
              guest.
            </p>
          </div>
        ...
        <div className='bg-gradient-to-r from-primary-50 to-secondary-50 rounded-2xl p-8'>
          <div className='text-center mb-8'>
            ...
            <p className='text-lg text-gray-600'>
              Enhance your beach experience with our exclusive services
            </p>
          </div>
