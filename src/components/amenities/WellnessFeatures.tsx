...
import { Dumbbell, Heart, Droplets, Leaf, Clock, Users, Award, Thermometer } from 'lucide-react';
  ...
  const wellnessFeatures: WellnessFeature[] = [
    {
      ...
      description: 'State-of-the-art equipment and professional training facilities',
      icon: Dumbbell,
      features: [
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Rejuvenate your body and mind at our comprehensive wellness center, featuring modern fitness 
            facilities, traditional saunas, and professional spa services designed to promote health and relaxation.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
          {wellnessFeatures.map((feature, index) => {
            ...
            return (
              <div key={index} className="bg-white rounded-lg shadow-soft p-8 hover:shadow-lg transition-shadow">
        ...
        <div className="bg-gradient-to-r from-primary-50 to-secondary-50 rounded-2xl p-8 mb-16">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600">Plan your wellness routine with our convenient schedules</p>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-soft p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Choose from our curated wellness experiences designed to revitalize and restore
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="border border-gray-200 rounded-lg p-6 hover:border-primary-300 transition-colors bg-primary-50">
              ...
              <p className="text-gray-600 mb-4">
                Complete wellness experience with fitness training and spa treatments
              </p>
              <ul className="text-sm text-gray-600 space-y-2 mb-6">
