      ...
      <div className='container mx-auto px-4'>
        ...
        <div className='text-center mb-12'>
          ...
          <p className='text-lg text-gray-600 max-w-3xl mx-auto'>
            Join our exciting daily activities designed for guests of all ages
            and interests. From wellness sessions to water sports, there's
                      ...
                      <div className='grid grid-cols-1 lg:grid-cols-4 gap-4 items-center'>
                        ...
                        <div>
                          <div className='flex flex-wrap gap-2'>
                            <span
                              className={`px-2 py-1 rounded-full text-xs ${getActivityTypeColor(activity.type)}`}
                            >
                            ...
                            {activity.difficulty && (
                              <span
                                className={`px-2 py-1 rounded-full text-xs ${getDifficultyColor(activity.difficulty)}`}
                              >
                                {activity.difficulty}
                              </span>
                            )}
          ...
          <div className='flex flex-wrap justify-center gap-4'>
            {[
              ...
              <div key={index} className='flex items-center'>
                ...
                <span
                  className={`px-3 py-1 rounded-full text-sm ${getActivityTypeColor(item.type as Activity['type'])}`}
                >
                  {item.label}
                </span>
              </div>
        ...
        <div className='mt-12 text-center'>
          <div className='bg-white rounded-lg shadow-soft p-8 max-w-2xl mx-auto'>
            ...
            <p className='text-gray-600 mb-6'>
              Contact our activities coordinator for private sessions, group
