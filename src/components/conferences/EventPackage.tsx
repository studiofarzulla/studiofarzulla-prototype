...
import { Users, Calendar, MapPin, Trophy, Building, Star, CheckCircle } from 'lucide-react';
...
export default function EventPackage({ packages, partners }: EventPackageProps) {
  const t = useTranslations('conferences');

  const defaultPackages: Package[] = [
    {
      name: 'Corporate Meeting Package',
      description: 'Perfect for business meetings, workshops, and corporate training sessions',
      duration: '4-8 hours',
      ...
      ideal_for: ['Board meetings', 'Training sessions', 'Workshops', 'Team meetings']
    },
    {
      name: 'Conference & Event Package',
      description: 'Comprehensive solution for large conferences, seminars, and corporate events',
      duration: '1-3 days',
      ...
      ideal_for: ['Conferences', 'Seminars', 'Product launches', 'Annual meetings']
    },
    {
      name: 'Corporate Retreat Package',
      description: 'Complete retreat experience combining business and leisure activities',
      duration: '2-5 days',
      ...
      ideal_for: ['Team building', 'Corporate retreats', 'Leadership programs', 'Company incentives']
    }
  ];
  ...
  const defaultPartners: CorporatePartner[] = [
    {
      ...
      description: 'Multi-day training programs and team building events for international staff'
    },
    {
      name: 'BP (British Petroleum)',
      logo: '/images/partners/bp-logo.png',
      event_type: 'Executive Meetings',
      description: 'High-level executive retreats and strategic planning sessions'
    },
    {
      name: 'Baku City Circuit (F1)',
      logo: '/images/partners/baku-circuit-logo.png',
      event_type: 'Employee Events',
      description: 'Annual employee appreciation events and corporate celebrations'
    },
    {
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            From intimate board meetings to large-scale conferences, our comprehensive packages 
            provide everything you need for successful corporate events.
          </p>
        </div>
          ...
          {eventPackages.map((pkg, index) => (
            ...
            >
              ...
              <div className="p-8">
                ...
                <Button className={`w-full ${pkg.popular ? 'bg-primary-600 hover:bg-primary-700' : ''}`}>
                  Get Quote
                </Button>
              </div>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-soft p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We're proud to have hosted successful events for these prestigious international organizations
            </p>
          </div>
