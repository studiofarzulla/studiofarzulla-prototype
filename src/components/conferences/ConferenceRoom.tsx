...
import { Users, Monitor, Wifi, Coffee, Car, Utensils, Mic, Presentation } from 'lucide-react';
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Our state-of-the-art conference facilities provide the perfect setting for successful business 
            events, from intimate board meetings to large corporate gatherings.
          </p>
        </div>
              ...
              <div className={index % 2 === 1 ? 'lg:order-1' : ''}>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p className="text-2xl font-bold text-primary-600">{room.capacity.theater}</p>
                  </div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p className="text-2xl font-bold text-primary-600">{room.capacity.classroom}</p>
                  </div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p className="text-2xl font-bold text-primary-600">{room.capacity.boardroom}</p>
                  </div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p className="text-2xl font-bold text-primary-600">{room.capacity.reception}</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <Button variant="outline" size="lg">View Floor Plan</Button>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="bg-gradient-to-r from-primary-50 to-secondary-50 rounded-2xl p-8 mb-16">
          <div className="text-center mb-8">
            <h3 className="text-3xl font-bold mb-4">Standard Equipment in All Rooms</h3>
            <p className="text-lg text-gray-600">
              Every conference room comes equipped with professional-grade technology and amenities
            </p>
          </div>
